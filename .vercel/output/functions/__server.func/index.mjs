...
var grokOgIdentity = { "site": {
	...
	"type": "website",
	"card": "custom",
	"description": "מבזק שעתי ממקורות ראשונים — איראן, לבנון, הציר, המפרץ והזירה הבינלאומית.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_oaEGY6 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_oaEGY6
	};
	return ((_m, p) => {
		return {
			data,
